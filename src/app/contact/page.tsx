        ...
        <section className="contact-hero">
          <div className="container">
            ...
            <p className="contact-copy">
              Whether you have a question, want to report content,
              apply for ministry verification, or need creator support
              — we are here to help.
            </p>
          </div>
        </section>
              ...
              <div className="contact-grid">
                ...
                <aside className="contact-sidebar">
                  ...
                  <div className="contact-note-card">
                    <p>
                      WorthCast is committed to maintaining a
                      trustworthy, family-safe Christian platform.
                      Reports and enquiries are handled with care
                      and confidentiality.
                    </p>
                  </div>
                </aside>
...
function ContactSuccess() {
  return (
    <div className="contact-success">
      ...
      <p>
        Thank you for reaching out to WorthCast. We will respond
        to your message within 2–3 business days.
      </p>
